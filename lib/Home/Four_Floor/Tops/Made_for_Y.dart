...
class MadeForY extends StatefulWidget {
  const MadeForY({Key? key}) : super(key: key);

  @override
  State<MadeForY> createState() => _MadeForYState();
}

class _MadeForYState extends State<MadeForY> {
        ...
        Row(
          children: [
            Padding(
              ...
              child: CircleAvatar(
                radius: 35,
                backgroundImage: AssetImage('image/p10.png'),
              ),
            ),
            Column(
              crossAxisAlignment: CrossAxisAlignment.start,
